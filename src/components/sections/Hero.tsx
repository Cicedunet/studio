...
const Hero = () => {
  return (
    <section id="decouvrir" className="relative pt-12 md:pt-20 pb-12 md:pb-20 overflow-hidden">
      <div
        className="absolute inset-x-0 top-0 h-full bg-[radial-gradient(circle_at_30%_20%,_var(--tw-gradient-stops))] from-secondary/40 via-background to-background"
        aria-hidden="true"
      />
      <div className="container relative mx-auto px-4 md:px-6">
        ...
        <div className="grid items-center gap-8 md:grid-cols-2 lg:gap-12">
          ...
          <div className="flex flex-col items-start space-y-6 animate-in fade-in slide-in-from-left-8 duration-1000 delay-200">
            <h1 className="font-headline text-4xl font-bold tracking-tight md:text-5xl lg:text-7xl text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent to-primary animate-gradient-x leading-[1.1]">
              Josy: L'Élégance & le Bien-Être au Quotidien
            </h1>
            <p className="text-lg text-muted-foreground md:text-xl">
              Je suis Josy, maman, professionnelle des chiffres et distributrice de parfums haut de gamme. Passionnée par le bien-être et l'élégance, je partage ici des produits et astuces qui vont ravir ton quotidien. Je t'aide également à construire ton propre business en toute liberté suivi de conseils à la clé.
              <br/><br/>
          ...
          <div className="flex justify-center items-center p-6 row-start-1 md:row-start-auto animate-in fade-in slide-in-from-right-8 duration-1000 delay-200">
            <Image
              ...
              width={250}
              height={250}
              className="rounded-full object-cover shadow-2xl ring-4 ring-primary/20 hover:scale-105 transition-transform duration-700"
            />
          </div>
        </div>
